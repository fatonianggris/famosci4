...
class UserClient extends ResourceController
{
    use ResponseTrait;

    public function __construct()
    {
        $this->UserClientModel = new UserClientModel();
        helper(['form']);
    }
    /**
    ...
    public function login()
    {
        ...
        $user = $this->UserClientModel->where('email', $email)->first();
        if (is_null($user)) {
            $response = [
                'status'   => 400,
    ...
    public function register()
    {
        ...
        if ($this->validate($rules)) {
            ...
            $this->UserClientModel->save($data);
            $response = [
                'status'   => 200,
                'error' => null,
    ...
    {
        $data = $this->UserClientModel->getWhere(['id_user_client' => $id])->getResult();
        if ($data) {
            $response = [
                'status'   => 200,
                'error'    => null,
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->UserClientModel->update($id, $data);
            $response = [
                'status' => 201,
                'error' => null,
